      ...
      {salesHistory.map((sale) => (
        <main key={sale.id} className="w-full ">
          <div className=" border rounded-lg  w-full ">
            <div className="p-3">
              <h2 className="font-bold text-base text-gray-500 border-b-2 border-gray-300 ">
                Sale ID: {sale.id}
              </h2>

              <p className="text-base text-gray-500 border-b-2 border-gray-300 font-bold">
            ...
            <p className="font-bold mt-4">Total Revenue: ₦{sale.total}</p>
